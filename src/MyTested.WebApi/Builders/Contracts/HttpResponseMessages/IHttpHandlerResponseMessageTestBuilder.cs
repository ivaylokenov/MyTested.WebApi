...
namespace MyTested.WebApi.Builders.Contracts.HttpResponseMessages
{
    ...
    public interface IHttpHandlerResponseMessageTestBuilder : IBaseHandlerTestBuilder
    {
        ...
        /// <returns>The same HTTP response message test builder.</returns>
        IAndHttpHandlerResponseMessageTestBuilder WithStringContent(Action<string> assertions);
        ...
        /// <returns>The same HTTP response message test builder.</returns>
        IAndHttpHandlerResponseMessageTestBuilder WithStringContent(Func<string, bool> predicate);
